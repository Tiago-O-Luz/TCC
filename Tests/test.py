...
HARD_PROMPT = 'Classify what type of cloud is presented in the image. Use strictly and only the ' + \
              'following outputs without any extra text or special characters, even if you don\'t have a clear ' + \
              'answer you must use one of these classifications: Cirriforms, Cumuliforms, Stratiforms, Stratocumuliforms'

SOFT_PROMPT = 'Identify if the image is showing a Cirriforms, Cumuliforms, Stratiforms or Stratocumuliforms cloud. Say that it is not clear if ' + \
              'an indentification is absolutely impossible. Use strictly and only the following outputs without ' + \
              'any extra text or special characters: Cirriforms, Cumuliforms, Stratiforms, Stratocumuliforms, Not clear'
